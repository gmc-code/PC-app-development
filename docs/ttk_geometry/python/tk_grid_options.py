...
def create_frame(root, title, row, column):
    frame = tk.LabelFrame(root, text=title, padx=10, pady=10)
...
root = tk.Tk()
root.title("Grid Options Examples")
# root.geometry("600x600")

# Rowspan example
frame1 = create_frame(root, "Rowspan Example", 0, 0)
...
# Columnspan example
frame2 = create_frame(root, "Columnspan Example", 0, 1)
