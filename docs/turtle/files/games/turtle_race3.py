...
p1 = createTurtlePlayer(
    "red", -210, 150
)  # red colored turtle at x position before 1st Line and y position 150
p2 = createTurtlePlayer(
    "blue", -210, 100
)  # blue colored turtle at x position before 1st Line and y position 100
p3 = createTurtlePlayer(
    "orange", -210, 50
)  # orange colored turtle at x position before 1st Line and y position 50
p4 = createTurtlePlayer(
    "green", -210, 0
)  # green colored turtle at x position before 1st Line and y position 0
