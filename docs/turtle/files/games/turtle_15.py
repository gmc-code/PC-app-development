...
for i in range(NUM_ROWS * NUM_COLS - 1):
    file = f"../number_images/{i+1}.gif"  # Use `.format()` instead if needed.
    images.append(file)

images.append("../number_images/empty.gif")
images.append("../number_images/scramble.gif")
...
def find_empty_square_pos():
    ...
    for row in board:
        for candidate in row:
            if candidate.shape() == "number_images/empty.gif":
