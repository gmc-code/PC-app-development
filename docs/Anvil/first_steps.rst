...
| e.g. self.text_box_1.text will return the text in teh text box named text_box_1.
...
| In an objects property events panel, click the blue arrow button to go to the method that runs when the event occurs. 
