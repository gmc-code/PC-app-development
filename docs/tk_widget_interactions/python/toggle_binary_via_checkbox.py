...
toggle_checkbutton = tk.Checkbutton(window, text="Toggle Binary", variable=bool_var, command=toggle_label)
toggle_checkbutton.grid(row=0, column=0, padx=10, pady=20)

# Create a Label widget
label = tk.Label(window, text="9", font=("Helvetica", 16), fg="black")
