...
# Validation function to ensure the input is a number
...
celsius_entry = tk.Entry(window, textvariable=celsius_var, font=("Helvetica", 12), validate="key", validatecommand=vcmd)
