...
# change the dictionary to look up these common Microsoft Office apps:

Outlook: An email and calendar application for managing communication and scheduling.
Word: A word processing tool for creating and editing documents.
PowerPoint: Used to create presentations with slides, graphics, and animations.
Excel: A powerful spreadsheet application for data analysis, calculations, and charts.
OneNote: A digital notebook for organizing notes, ideas, and research.
Access: A database application for creating and managing data-driven applications.
Publisher: Used for desktop publishing, creating brochures, flyers, and other print materials.

# change bg colours from yellow to light green
