...
class QuizGame:
    ...
    def __init__(self, root):
        ...
        self.start_button = tk.Button(root, text="Start Quiz", command=self.start_quiz, bg="blue", fg="white", width=20, height=2, font=("Helvetica", 12))
        ...
        self.submit_button = tk.Button(self.question_frame, text="Submit", command=self.check_answer, bg="lime green", fg="white", width=20, height=2, font=("Helvetica", 12))
