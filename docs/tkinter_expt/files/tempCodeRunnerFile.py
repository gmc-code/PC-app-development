...
def convert_f_to_c():
    try:
        ...
        c_text.delete(1.0, tk.END)  # Clear any previous result
        c_text.insert(tk.END, f'{celsius:.1f}')
    except ValueError:
        c_text.delete(1.0, tk.END)
        c_text.insert(tk.END, "Invalid input. Please enter a valid Fahrenheit value.")
