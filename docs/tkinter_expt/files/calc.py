...
button_add = Button(window, text="+", padx=39, pady=20, font=('Arial', 25), command=button_add)
button_equal = Button(window, text="=", padx=102, pady=20, bg='green', font=('Arial', 25), command=button_equal)
