...
lab_1.grid(row=0, column=0, sticky=nw_sticky, padx=corner_padx, pady=corner_pady, ipadx=corner_ipadx, ipady=corner_ipady)

lab_2 = Label(w, text='row 0, column 1', font='Verdana 16', width=20, height=5, bg='yellow')
...
lab_3.grid(row=0, column=2, sticky=ne_sticky, padx=corner_padx, pady=corner_pady, ipadx=corner_ipadx, ipady=corner_ipady)

lab_4 = Label(w, text='row 1, column 0', font='Verdana 16', width=30, height=5, bg='orange')
lab_4.grid(row=1, column=0, sticky=sw_sticky, padx=corner_padx, pady=corner_pady, ipadx=corner_ipadx, ipady=corner_ipady)

lab_5 = Label(w, text='row 1, column 1', font='Verdana 16', width=30, height=5, bg='blue')
lab_5.grid(row=1, column=1, sticky=news_sticky)

lab_6 = Label(w, text='row 1, column 2', font='Verdana 16', width=30, bg='pink')
lab_6.grid(row=1, column=2, padx=corner_padx, pady=corner_pady, ipadx=corner_ipadx, ipady=corner_ipady)

lab_7 = Label(w, text='row 2, column 0', font='Verdana 16', bg='purple')
lab_7.grid(row=2, column=0, sticky=sw_sticky)

lab_8 = Label(w, text='row 2, column 1', font='Verdana 16', height=5, bg='cyan')
lab_8.grid(row=2, column=1)

lab_9 = Label(w, text='row 2, column 2', font='Verdana 16', bg='magenta')
lab_9.grid(row=2, column=2, sticky=se_sticky, padx=corner_padx, pady=corner_pady, ipadx=corner_ipadx, ipady=corner_ipady)
