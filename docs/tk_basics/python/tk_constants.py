...
def anchor_demo(parent):
    lbl = tk.Label(parent, text="anchor=tk.W", bg="#d0eaff")
    lbl.pack(anchor=tk.W)

def anchor_center_demo(parent):
    lbl = tk.Label(parent, text="anchor=tk.CENTER", bg="#d0eaff")
...
def sticky_demo(parent):
    lbl = tk.Label(parent, text="sticky=tk.NS", bg="#d0eaff")
    parent.grid_rowconfigure(0, weight=1)
    parent.grid_columnconfigure(0, weight=1)
    lbl.grid(row=0, column=0, sticky=tk.NS)
